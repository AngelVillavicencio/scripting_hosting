              ...
              <div class="container_popup" id="content_modal_register">
                  ...
                  <div class="container_popup_info">
                      ...
                      <div class="container_popup_info__form">
                          <div>
                            <input placeholder="Ingresa tu nombre" type="text" class="info__form-inputtext" />
                          </div>
                          <div>
                            <input placeholder="Ingresa tu DNI o C.E." type="number" class="info__form-inputtext" />
                          </div>
                          <div>
        ...
        fn: {
            ...
            isValidForm: () => {
                ...
                var nombreInput = document.querySelector(
                    '.info__form-inputtext[type="text"]'
                );
                ...
                var documentID = document.querySelector(
                    '.info__form-inputtext[type="number"]'
                );
                ...
                if (
                    !(documentID.value?.length >= 8 && documentID.value?.length <= 20)
                ) {
                    me.fn.addErrorMessage(documentID, "Documento inválido");
                    return false;
                }
                if (
                    /^\w+([.-]?\w+)@\w+([.-]?\w+)(.\w{2,3})+$/.test(
            ...
            register: () => {
                ...
                var documentType = documentID.length == 8 ? "dni" : "ce";
